...
import com.kalhan.springsecurity.filter.*;
...
public class ProjectSecurityConfig {
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
       ...
       /* http.securityContext((context) -> context.requireExplicitSave(false))
                .sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.ALWAYS))*/ //jsessionid burası her seferinde üretiyor onun yerine jwt için
        http.sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS)) //jwt için burayı yazdık
